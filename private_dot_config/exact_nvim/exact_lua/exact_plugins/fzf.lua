return {
  ...
  keys = {
    ...
    {
      "<leader>fS",
      function() require("fzf-lua").live_grep({ rg_opts = "--hidden --no-ignore --column --line-number --no-heading --color=always --smart-case" }) end,
  ...
  config = function()
    ...
    actions = {
      ...
      files = {
        ...
        ["ctrl-g"] = actions.toggle_ignore, -- not ctrl-i: fzf reads it as Tab
